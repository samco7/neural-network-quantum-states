...
class MetropolisSampler(object):
    ...
    def __init__(self, hamiltonian, nqs, zero_magnetization=False,
    ...
    def estimate_wf_energy(self):
        ...
        print(energy_report.format(np.squeeze(est_avg), est_error))
        ...
        print(autocorrelation.format(np.squeeze(self.correlation_time)))
